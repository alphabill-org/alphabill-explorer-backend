...
type MockStorageService struct {
	...
	getRoundNumberFunc           func(ctx context.Context) ([]partition.RoundInfo, error)
...
func (m *MockStorageService) FindTxs(ctx context.Context, searchKey []byte, partitionIDs []types.PartitionID) ([]*domain.TxInfo, error) {
	panic("implement me")
}

func (m *MockStorageService) GetBillsByPubKey(ctx context.Context, ownerID hex.Bytes) (res []*wallettypes.Bill, err error) {
	panic("implement me")
}

func (m *MockStorageService) GetTxsPage(ctx context.Context, partitionID types.PartitionID, startID string, limit int) (transactions []*domain.TxInfo, previousID string, err error) {
...
func (m *MockStorageService) GetUnitsByOwnerID(ctx context.Context, ownerID hex.Bytes) ([]types.UnitID, error) {
	panic("implement me")
}

func (m *MockStorageService) GetBlock(ctx context.Context, blockNumber uint64, partitionIDs []types.PartitionID) (map[types.PartitionID]*domain.BlockInfo, error) {
...
func (m *MockStorageService) GetBlocksInRange(ctx context.Context, partitionID types.PartitionID, dbStartBlock uint64, count int, includeEmpty bool) (res []*domain.BlockInfo, prevBlockNumber uint64, err error) {
...
func (m *MockStorageService) GetTxsByBlockNumber(ctx context.Context, blockNumber uint64, partitionID types.PartitionID) ([]*domain.TxInfo, error) {
	panic("implement me")
}

func (m *MockStorageService) GetTxsByUnitID(ctx context.Context, unitID types.UnitID) ([]*domain.TxInfo, error) {
	panic("implement me")
}

func (m *MockStorageService) GetLastBlock(ctx context.Context, partitionIDs []types.PartitionID) (map[types.PartitionID]*domain.BlockInfo, error) {
...
func (m *MockStorageService) GetLastBlocks(ctx context.Context, partitionIDs []types.PartitionID, count int, includeEmpty bool) (map[types.PartitionID][]*domain.BlockInfo, error) {
...
func (m *MockStorageService) GetTxByHash(ctx context.Context, txHash domain.TxHash) (res *domain.TxInfo, err error) {
...
func (m *MockStorageService) GetBlockTxsByBlockNumber(blockNumber uint64) (res []*domain.TxInfo, err error) {
